...
from mani_skill2.agents.configs.xarm6 import defaults
...
class xarm6(BaseAgent):
    _config: defaults.xarm6DefaultConfig

    @classmethod
    def get_default_config(cls):
        return defaults.xarm6DefaultConfig()
